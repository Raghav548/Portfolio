    ...
    >
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="mt-2 my-4 md:mb-8">
          <p className="mb-1">
            I am a Full-Stack Developer with passion of building cool web-applications
          </p>
          <p>
            <br />
             I’m a passionate Full Stack Developer who loves building sleek, responsive, and high-performance web applications. With expertise in React, Node.js, Express, and MongoDB, I bridge the gap between frontend aesthetics and backend efficiency.

💡 From designing pixel-perfect UIs to optimizing database queries, I enjoy solving complex problems with clean and scalable code. I believe in continuous learning and staying up to date with the latest tech trends to craft innovative digital experiences.

✨ Whether it’s developing a dynamic website, an interactive dashboard, or a scalable API, I strive to create solutions that are not only functional but also user-friendly. Let’s build something amazing together!
          </p>
        </div>
